            ...
            <div className="flex-grow flex items-center justify-center">
                <div className="w-[800px] p-[30px] h-[600px] bg-white rounded-[50px] shadow relative">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5 items-center mt-12">
                        {!isLogin && (
                            <>
                                <input
                                    ...
                                    required
                                    className="input bg-[#4B297138] h-12 w-[500px] rounded-[10px] border border-gray-300 text-black focus:outline-none focus:ring-2 focus:ring-blue-500"
                        ...
                        <button
                            type="submit"
                            className="bg-[#581C87] h-10 w-[500px] text-white p-2 rounded-[100px] hover:bg-pink-500 hover:border-pink-400 focus:outline-none focus:ring-2 focus:ring-blue-500 mt-8"
                        >
