  ...
  return (
    <div className="min-h-screen bg-[#161527] text-white">
          ...
          <div className="bg-[#1e1c38] rounded-xl px-14 py-10 shadow-xl mb-12 max-w-screen-lg mx-auto">
            <div
              className={`grid gap-6 ${
                activeTab === 'sales' ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1 md:grid-cols-3'
              }`}
            >
              {activeTab === 'sales' && (
                ...
                <div className="flex flex-col md:flex-row gap-6 w-full md:col-span-2 items-stretch">
                  ...
                  <div className="flex-1 md:flex-[1_1_66%] flex flex-col justify-between h-full">
                    <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                      <div className="bg-[#161936] p-6 rounded-lg border border-white flex flex-col justify-between">
                        <h3 className="text-lg font-semibold mb-2">Vietnam Office</h3>
                        <p>
                          Our Vietnamese headquarters are located in Ho Chi Minh City, focusing on R&D and local support.
                        </p>
                      </div>
                      <div className="bg-[#161936] p-6 rounded-lg border border-white flex flex-col justify-between">
                        <h3 className="text-lg font-semibold mb-2">Korea HQ</h3>
                        <p>
                          The Seoul office serves as our international headquarters and manages global operations.
                        </p>
                      </div>
                      <div className="bg-[#161936] p-6 rounded-lg border border-white flex flex-col justify-between">
                        <h3 className="text-lg font-semibold mb-2">Support Portal</h3>
                        <p>
                          Access documentation, submit tickets, and get help through our dedicated portal.
                        </p>
                      </div>
                      <div className="bg-[#161936] p-6 rounded-lg border border-white flex flex-col justify-between">
                        <h3 className="text-lg font-semibold mb-2">Press & Media</h3>
                        <p>
                          For media inquiries, branding assets, and press releases, please contact our PR team.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <div className="relative z-0">
        <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-[#161527] to-transparent z-10" />
        <div className="relative bg-[#1e1c38] px-6 md:px-16 py-16 z-0">
          <h2
            className="text-4xl font-black bg-clip-text text-transparent mb-6 inline-block tracking-tighter text-center"
            style={{
              backgroundImage: 'linear-gradient(150deg, #00A1C7, #F5559E, rgb(239, 162, 86))',
              fontFamily: 'Anton, sans-serif',
            }}
          ...
          <div className="space-y-6 max-w-3xl mx-auto">
            <div>
              <h4 className="font-bold">I need to reset my password.</h4>
              <p>
                To reset your password, enter your username and click RESET PASSWORD via the link
                below.
              </p>
              ...
              <p>
                Once you submit this, you will receive an email with instructions on how to complete
                the process.
              </p>
            </div>

            <div>
              <h4 className="font-bold">How can I book a Tarot reader?</h4>
              <p>
                Visit our booking section to select a reader, choose your time, and follow the
                instructions.
              </p>
